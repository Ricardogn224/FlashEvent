                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          const SizedBox(width: 8),
                                          Text(DateFormat.yMMMd().format(DateTime.parse(eventParty.dateStart))),
                                          const SizedBox(width: 8),
                                          Text(DateFormat.Hm().format(DateTime.parse(eventParty.dateStart))),
                                        ],
                                      ),
                                      const Divider(),
                                      Row(
                                        children: [
                                          const Icon(Icons.calendar_today, color: Color(0xFF6058E9)),
                                          const SizedBox(width: 8),
                                          Text(DateFormat.yMMMd().format(DateTime.parse(eventParty.dateEnd))),
                                          const SizedBox(width: 8),
                                          Text(DateFormat.Hm().format(DateTime.parse(eventParty.dateEnd))),
                                        ],
                                      ),
                                      const Divider(),
                                      Row(
